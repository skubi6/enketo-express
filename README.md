...
5. To stop, execute `docker-compose stop` from the project directory. Database dumps from the main Redis instance will be mapped to the directory `setup/docker/redis_main_data/`.
